...
import ScholarshipCard from "@/components/Reusables/ScholarshipCard";
  ...
  const renderHeader = () => (
    <>
      <View className="pt-6">
        ...
        />
        <TextContainer
          content={`Discover funding opportunities for your education journey.`}
      ...
      <View className="flex-row justify-start items-center gap-2 pt-6 pb-4">
        ...
        <TextContainer
          content={`${scholarships.length} Scholarships available`}
    ...
    <View className="bg-[#F9FAFB] flex-1">
      <View className="pt-16 flex-1">
        ...
        <FlatList
          ...
          renderItem={({ item }) => <ScholarshipCard scholarship={item} />}
