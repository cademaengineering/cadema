        ...
        <View className="pt-16 flex-1">
          ...
          <View className="px-6 flex-1">
            <FlatList
              ...
              renderItem={({ item }) => <LearnCard id={item.id} />}
              showsVerticalScrollIndicator={false}
              contentContainerStyle={{ paddingBottom: 24 }}
              ItemSeparatorComponent={() => <View style={{ height: 16 }} />}
            />
          </View>
          <View className="flex justify-center items-center py-3 mb-4">
            <TouchableOpacity className="bg-[#EBEBEB] rounded-full px-8 py-3">
              <TextHeader
                content="View learning history"
